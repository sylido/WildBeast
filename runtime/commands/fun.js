var Commands       = [],
    ...
    kubaDictionary = [
      ...
      "this year for sure",
      "leaving for week, mother is sick",
      "leaving for 2 week, father in hospital",
      "leaving for 3 week, brother in jail",
      "leaving for month, sister pregnant",
      "leaving for a quarter, going to jail for scamming cryptospeculators around world",
      "leaving for a year, germany invaded poland, again",
      "leaving forever, won lotto",
      "be back in a hour, lost phone in woods"
    ],
    ...
    dedsec  = [":skull:", ":ghost:", ":snake:", ":skull_crossbones:"];

Commands.kuba = {
  name: 'kuba',
  aliases: ['kubafacts', 'askkuba', 'askuba', 'whereiskuba', 'dzwilldo', 'ciberbasedgod', 'aeidiotsuckscock'],
  help: "COINVESTMENT IS THE BEST - SUBSCRIBE NOW only 0.01 BTC per month !",
  noDM: true, // Ratelimits Ratelimits Ratelimits Ratelimits
  timeout: 5,
  level: 0,
  fn: function (msg) {
    msg.channel.sendMessage(dedsec[_.random(0, dedsec.length -1)] + " kuba: " + kubaDictionary[_.random(0, kubaDictionary.length - 1)]);
  }
};
